...
//      / \    \
//     4-> 5 -> 7 -> NULL
//  Subscribe to see which companies asked this question Show Tags Tree Depth-first Search Show Similar Problems (M) Populating Next Right Pointers in Each Node
// 
